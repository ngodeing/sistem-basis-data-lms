    ...
    <div class="container">
        ...
        <table class="table table-hover-dark table-bordered text-center">
            ...
            <tbody>
                <?php
                require 'koneksi.php';
                $hasil = mysqli_query($conn, "SELECT * FROM mata_kuliah")
                ?>
                <?php
                $no = 1;
                while ($data = mysqli_fetch_array($hasil)) {
                    ...
                    echo "<td>
            <a href='edit_barang.php?kode_mk=$data[kode_mk]' class='btn btn-warning btn-sm' style='font-weight: 600;'>Edit</a>|
            <a href='delete_barang.php?kode_mk=$data[kode_mk] ' class='btn btn-danger btn-sm' style='font-weight: 600;'>Delete</a>
            </td>";
                    echo "</tr>";
                    $no++;
                }
